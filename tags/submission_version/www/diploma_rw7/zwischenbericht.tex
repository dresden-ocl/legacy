...
{\par\centering \textbf{\Large Werkzeugunterstützung für die Überprüfung der
Einhaltung von OCL-Geschäftsregeln in Java-Programmen}\Large \par}
...
{\par\centering \textbf{\Large Übersicht}\Large \par}
...
\begin{enumerate}
\item Post-Code an jeder return-Anweisung
\item Vorausberechnung des Rückgabeausdrucks
...
Wann müssen die Invarianten erfüllt sein?

\begin{itemize}
\item Alle Methoden.
\item Öffentliche Methoden.
\item Ausgezeichnete Methoden.
\item Explizite Prüfung.
\end{itemize}

\lyxnewslide{}

{\par\centering \textbf{\Large Caching von Invarianten -}\\
\textbf{\Large Überwachung von Attributen}\Large \par}
...
{\par\centering \textbf{\Large Caching von Invarianten - }\\
\textbf{\Large Beispiele}\Large \par}

\vspace{10pt}\hrule height 4pt

\vspace{0.3cm}
{\par\centering \resizebox*{1\textwidth}{!}{\includegraphics{PersonCompany.eps}} \par}
\vspace{0.3cm}
...
\begin{itemize}
\item Anwendung bei net-linx
\item Scope von Invarianten

\begin{itemize}
\item Unterstützung von ausgezeichneten Methoden
\end{itemize}
\item Caching von Invarianten

\begin{itemize}
\item Einschränkung der observierten Attribute im Typechecker
\item Observation von Methoden
\end{itemize}
\end{itemize}

\lyxnewslide{}

{\par\centering \textbf{\Large Erweiterte Typinformation}\Large \par}
...
{\par\centering \textbf{\Large Erweiterte Typinformation - }\\
\textbf{\Large Statische Analyse}\Large \par}

\vspace{10pt}\hrule height 4pt

\begin{lyxcode}
/{*}{*}~\\
~~~All~employed~\{@link~\underbar{Person}~persons\}~~\\
~~~of~this~company.~\\
~~~@see~\underbar{Person}~\\
{*}/~\\
Collection~employees;~\\
