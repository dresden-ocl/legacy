...
trait OclAttributes { selfType : OclStaticSemantics =>
  ...
  protected val isMultipleNavigationCall : Attributable ==> Box[Boolean] =
    childAttr {
  ...
  protected val namespace : Attributable ==> Box[Namespace] = {
    childAttr {
      case child => {
  ...
  protected val lastNamespace : Attributable ==> Box[Namespace] = {
    attr {
  ...
  protected val self : Attributable ==> Box[Variable] = {
    childAttr {
      case child => {
        case null => Empty
  ...
  protected val context : Attributable ==> Box[ConstrainableElement] = {
    childAttr {
      case child => {
        case null => Empty
  ...
  protected val sourceExpression : Attributable ==> Box[OclExpression] = {
    childAttr {
      case child : AttributableEObject => {
        case null => Empty
  ...
  protected val isInPostCondition : Attributable ==> Boolean = {
    childAttr {
      case child => {
        case null => false
