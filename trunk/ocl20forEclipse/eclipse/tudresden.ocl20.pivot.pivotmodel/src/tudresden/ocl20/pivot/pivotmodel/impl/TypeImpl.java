...
public class TypeImpl extends NamedElementImpl implements Type {
	 ...
	 * <em>Owned Operation</em>}' containment reference list. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * {@link #getSuperTypeGen()} which contains the code generated by EMF.
	...
	/**
	 * The code generated for {{@link #getOwnedOperation()} is redirected to
	 * this method.
	 * 
	 * @generated
	 */
	...
	public List<Property> allProperties() {
		...
		while (!typesToVisit.isEmpty()) {
			...
			for (Property property : currentType.getOwnedProperty()) {
				/*
				 * Check if a property is shadowed by another property of a sub
				 * type.
				 */
	 ...
	 * {@link EObjectEList}s should be copied into a new list before calling
	 * this method.
	 * 
	 * @generated NOT
	 */
