...
modus all subclass properties will be written to one table of the super class (often called generalization table).
...
Integrity View} otherwise the table schema will be generated as well. The other
...
Basically this chapter describes the translation of OCL invariants to SQL integrity views by the 
